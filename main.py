    ...
    for round in range(1,4):
        ...
        for carta in cartas:
            if carta_escolhida == carta.valor:
                carta.printar_carta_escolhida(jogador.nome, carta_escolhida)
        ...
        for carta in cartas:
            if valor_carta_computador == carta.valor:
                carta.printar_carta_escolhida(computador.nome, valor_carta_computador)
        ...
        ganhou = jogo_iniciado.verifica_vencedor_jogo(contador_round_jogador1, jogador.nome, contador_round_jogador2, computador.nome, round)
